...
/**
 * Monthly returns heatmap — fully from /api/bybit/monthly-returns (DB-based).
 * No static data. Third-party reproducible.
 */
export function MonthlyReturnsHeatmap() {
  const { data } = useSWR<{ returns: MonthlyReturn[] }>(
    "/api/bybit/monthly-returns",
    fetcher,
